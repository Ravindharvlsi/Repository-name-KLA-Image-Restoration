...
from model_v4 import V4RestorationNet
...
RESULT_DIR = r"C:\KLA\results\model_v4"
CHECKPOINT_DIR = r"C:\KLA\results\model_v4\checkpoints"
...
print("=" * 70)
print("V4 IMAGE RESTORATION TRAINING")
print("=" * 70)
...
print("Model: V4RestorationNet")
print("Features: 64")
print("RCAB blocks: 20")
