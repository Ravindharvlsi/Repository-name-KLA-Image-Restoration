...
V5_CHECKPOINT = (
    r"C:\KLA\results\model_v5\checkpoints\best_model_v5.pth"
)

V6_CHECKPOINT_DIR = (
    r"C:\KLA\results\model_v6\checkpoints"
)
...
print("=" * 70)
print("V6 - V5 CHECKPOINT RESUME TRAINING")
print("=" * 70)
...
print("V5 architecture loaded for V6 training.")
...
print(
    "V5 checkpoint loaded successfully."
)

print(
    "Starting PSNR:",
    checkpoint.get("psnr", "unknown")
)

print(
    "Starting SSIM:",
    checkpoint.get("ssim", "unknown")
)
